...
Ce repossitory vien de la serie de tutoriels pour construir une REST API avec NestJS et Prisma.

Grace a ce turoriel on va apprendre:

- NestJS comme backend framework.
...
# Parts de cette serie

Part 1: Building a REST API with NestJS and Prisma

- https://www.prisma.io/blog/nestjs-prisma-rest-api-7D056s1BmOL0#create-a-postgresql-instance
...
Part 5: Building a REST API with NestJS and Prisma: Authentication
